...
$sql_list = "SELECT list FROM tarumiku_kensaku";
...
// 実行（itemsテーブルからデータ取得）
$sql_items = "SELECT * FROM tarumiku_items0 $whereClause";
...
// 実行（itemsテーブルからデータ取得）
$sql_items1 = "SELECT * FROM tarumiku_items1 $whereClause1";
...
<body>
<!-- 検索 -->
<form action="tarumiku.php" method="POST">
...
<a href="http://localhost/seisakujisyu_Y/HTML/src/tarumiku.php">検索を解除</a><br />
<?php } ?>
<p>○ その災害時に利用できる施設<br>
× 原則利用できない施設<br>
