...
<!--検索-->
<form action="kitaku.php" method="POST">
...
<a href="http://localhost/seisakujisyu_Y/HTML/src/kitaku.php">検索を解除</a><br />
<?php } ?>
